...
void loop() {
  ...
  int potiMap = map(poti, 0, 1023, 0, 100);

  Serial.println(potiMap);
//   // Move the LSS continuously in the oposite direction

  mySerial.print(String("#") + NEW_ID_ONE + String("WR") + -potiMap + "\r"); // RPM move

  mySerial.print(String("#") + NEW_ID_TWO + String("WR") + potiMap  + "\r"); // RPM move
